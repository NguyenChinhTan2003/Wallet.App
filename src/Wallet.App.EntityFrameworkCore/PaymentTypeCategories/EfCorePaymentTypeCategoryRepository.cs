...
{
    public abstract class EfCorePaymentTypeCategoryRepositoryBase : EfCoreRepository<AppDbContext, PaymentTypeCategory, int>
    {
        public EfCorePaymentTypeCategoryRepositoryBase(IDbContextProvider<AppDbContext> dbContextProvider)
