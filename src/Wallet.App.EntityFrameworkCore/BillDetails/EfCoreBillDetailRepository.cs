...
{
    public abstract class EfCoreBillDetailRepositoryBase : EfCoreRepository<AppDbContext, BillDetail, int>
    {
        private readonly ICurrentUser _currentUser;
        public EfCoreBillDetailRepositoryBase(IDbContextProvider<AppDbContext> dbContextProvider , ICurrentUser currentUser)
        ...
        public virtual async Task<List<TotalCategoryViewModel>> GetCategory()
        {
